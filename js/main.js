...
app.common = {
  init: function() {
    ...
    $(".section--activities .section__body .col-md-3").click(function() {
      console.log($(this).index());
      return selectFilters($(this).index());
    });
    selectFilters = function(index) {
      return $(".section__body").find("article").removeClass("current").eq(index).addClass("current");
    };
    $(".sticky .sticky__button").click(function() {
      return $(this).parent(".sticky").addClass("sticky__banner--on");
    });
    return $(".sticky .sticky__close").click(function() {
      return $(this).parents(".sticky").removeClass("sticky__banner--on");
    });
  }
};
...
app.scroll = {
  init: function() {
    ...
    $("[data-goto-tab]").click(function(e) {
      e.preventDefault();
      return app.scroll.goto_tab($(this).attr("data-goto-tab"));
    });
  ...
  trigger: function() {
    ...
    if ($(window).width() > 700) {
      ...
      return $("[data-sticky]").each(function() {
        var el, el_height, el_selector, el_top, filters_top;
        el = $(this);
  ...
  checkGoto: function() {
    ...
    if ($index > 2) {
      return $(".section__nav__sticky").scrollLeft(500);
    } else {
      return $(".section__nav__sticky").scrollLeft(0);
    }
  },
  goto_tab: function(to, add, seconds) {
    var from, top;
    if (add == null) {
      add = 0;
    }
...
app.swiper = {
  init: function() {
    var swiper, swiper2;
    swiper = new Swiper('.swiper-driven', {
      loop: true,
      autoplay: {
        delay: 3000
      },
    ...
    return swiper2 = new Swiper('.swiper-supported', {
      loop: true,
      autoplay: {
        delay: 3000
      },
